...
const app = express();
const cache = new NodeCache({ stdTTL: 15 }); // 15-second default TTL
...
// Returns current price, change, high, low, prev close
...
// Returns up to 8 matching tickers/companies
...
// Returns company name, logo, industry, market cap, website
...
// Returns last 5 company news articles
app.get('/api/news', async (req, res) => {
  ...
  try {
    const data = await finnhub('/company-news', {
      symbol: symbol.toUpperCase(),
      from,
      to,
    });
